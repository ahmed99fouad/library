...
class Members extends StatefulWidget {
  ...
  Members(this.note, this.appBarTitle);

  @override
  State<StatefulWidget> createState() {
    return MembersState(this.note, this.appBarTitle);
  }
}

class MembersState extends State<Members> {
  static var _priorities = ['عضو', ''];
  ...
  MembersState(this.note, this.appBarTitle);
